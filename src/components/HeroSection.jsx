      ...
      <div className="relative max-w-4xl mx-auto flex flex-col items-center text-center p-6 sm:p-10 lg:p-16 z-10">
        ...
        <div className="flex items-center gap-3 mb-6 justify-center">
          ...
          <div className={`hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold border ${
            ...
            <Activity className="w-3 h-3 animate-pulse text-[#00E599]" />
        ...
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black mb-6 leading-[1.08] tracking-tight">
          ...
          <br />
          <span className="inline-block mt-2 px-4 py-1 rounded-2xl bg-[#00E599] text-black font-black shadow-sm">
            With Precision AI.
          </span>
        </h1>
        ...
        <form onSubmit={handleSearchSubmit} className="mb-8 w-full max-w-2xl">
          <div className={`flex items-center gap-2 p-2 rounded-2xl border transition-all duration-300 ${
            ...
            <button
              type="submit"
              className="px-5 sm:px-6 py-3 rounded-xl font-bold text-xs sm:text-sm flex items-center gap-1.5 btn-interactive cursor-pointer bg-[#00E599] text-black hover:bg-[#00CC88] flex-shrink-0"
            >
              <span>Find</span>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-8">
          <button
            ...
            className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-2xl font-black text-sm sm:text-base btn-interactive hover-lift shadow-xl cursor-pointer bg-[#00E599] text-black hover:bg-[#00CC88] shadow-emerald-500/20"
          >
          ...
          >
            <HelpCircle className="w-5 h-5 text-[#00E599] transition-transform group-hover:scale-110" />
